// Package media contiene utilidades autocontenidas de media para el bridge:
// el análisis de audio Ogg/Opus (duración + waveform) y el downloader que
// implementa la interfaz whatsmeow.DownloadableMessage. No depende del estado
// global del proceso, así que es testeable de forma aislada.
package media
